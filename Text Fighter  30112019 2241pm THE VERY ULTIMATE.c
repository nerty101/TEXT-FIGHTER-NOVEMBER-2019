...
if (((torwnrt > 0) && (posdef > 0) && (torwnrt == 100)) || ((torwnrt > 0) && (posdef > 0) && (torwnrt <= 99) && (wnrtrec <= 99) && (wnrtrec3 > 0)))
printf("\n     Tournament Win High: %.2f%%", wnrtrec);
if ((torwnrt > 0) && (posdef > 0) && (torwnrt != 100) && (wnrtrec > 0) && (wnrtrec3 < 1))
printf("\n     Tournament Win High:  %.2f%%", wnrtrec);
}
}
if (cpuwn2 > 0)
...
if (diceQ == 9)
printf("     You still have potential!\n\n");
