...
int diflev = 6, posdef = 0, posmag = 0, posbon = 0, bonchn = 0, bonchn2 = 0, cpusp = 0, consecvic4 = 0, spctrbon3 = 0, ultsp = 0, ultsp3 = 0, ultsp4 = 0;
...
int mspatt3 = 0, emgspcom3 = 0, hypsp2 = 0, spatt2 = 0, supspatt2 = 0, emgspcom4 = 0, mspatt4 = 0, new0 = 1, bonrec5 = 0, dmg = 0, dmg2 = 1;
...
if (diceQ1 == 6)
printf("     Ready for another bout?\n\n");
if (diceQ1 == 7)
printf("     Sharpen your technique!\n\n");
if (diceQ1 == 8)
