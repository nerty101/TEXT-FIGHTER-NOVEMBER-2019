...
{
Sleep (300);
if ((posdef > 0) && (torwnrt == 100) && (torwnrt > 9) && (wnrtrec > 9) && (cpuwn2 < 2))
printf("     Tournament Win Rate: %.2f%%", torwnrt);
if (((posdef > 0) && (torwnrt != 100) && (torwnrt > 9) && (wnrtrec > 9) && (cpuwn2 < 2)) || ((posdef > 0) && (torwnrt > 0) && (torwnrt < 10) && (wnrtrec < 10) && (cpuwn2 < 2)))
printf("     Tournament Win Rate:  %.2f%%", torwnrt);///REDUCED BY 1
if ((posdef > 0) && (torwnrt < 10) && (wnrtrec > 9) && (cpuwn2 < 2))
printf("     Tournament Win Rate:   %.2f%%", torwnrt);
if ((posdef > 0) && (torwnrt > 9) && (wnrtrec < 10) && (cpuwn2 < 2))
printf("     Tournament Win Rate: %.2f%%", torwnrt);
if ((posdef > 0) && (torwnrt < 1) && (wnrtrec < 1) && (cpuwn2 >= 1))/// LESS THAN 10 NOT 1? BUT LOOK 6 LINES UP!
printf("     Tournament Win Rate: %.2f%%", torwnrt);
if (((posdef > 0) && (torwnrt > 9) && (wnrtrec3 > 9) && (cpuwn2 > 1)) || ((posdef > 0) && (torwnrt > 0) && (torwnrt < 10) && (wnrtrec3 < 10) && (cpuwn2 > 1)))
printf("     Tournament Win Rate: %.2f%%", torwnrt);///reduced by one 1339pm
...
printf("\n     Tournament Win High:  %.2f%%", wnrtrec);///REDUCED BY 1
}
}
if (cpuwn2 > 0)
Sleep(300);
...
if (((diceQ > 9) && (diceQ1 != 1) && (diceQ1 < 12)) || ((diceQ1 != 1) && (diceQ1 < 12) && ((diceQ == 5) && (ctr < 9))))
printf("\n");
