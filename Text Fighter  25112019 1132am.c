...
{
printf("  ");
++prntcor;///new, check, uniformity?
++b;
}
if ((a > 0) && (b < 1) && (cpuwn2 <= 1))
printf("Tournament Win Low:   %.2f%%\n", wnrtrec3);
if ((a > 0) && (b < 1) && (cpuwn2 > 1) && (wnrtrec3 < 1) && (torwnrt > 0))
printf("Tournament Win Low:    %.2f%%\n", wnrtrec3);
if ((a > 0) && (b < 1) && (cpuwn2 > 1) && (wnrtrec3 < 1) && (torwnrt < 1))
printf("Tournament Win Low:   %.2f%%\n", wnrtrec3);
if ((a > 0) && (b < 1) && (cpuwn2 > 1) && (wnrtrec3 > 0))
printf("Tournament Win Low:   %.2f%%\n", wnrtrec3);
if ((a < 1) && (b > 0) && (wnrtrec3 < 1))
printf("Tournament Win Low:  %.2f%%\n", wnrtrec3);
if ((a < 1) && (b > 0) && (wnrtrec3 > 0))
printf("Tournament Win Low: %.2f%%\n", wnrtrec3);
prntcor = 0;
a = 0;
b = 0;
